...
from tensorflow.contrib.arg_scope import add_arg_scope as contrib_add_arg_scope
from tensorflow.contrib import gen_variable_ops
from tensorflow.contrib import loader
