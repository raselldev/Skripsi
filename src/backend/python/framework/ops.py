...
from backend.core.framework import op_def_pb2
from backend.python.framework import errors_impl as errors
from backend.core.framework import attr_value_pb2
from backend.python.framework import dtypes
from backend.python.util import tf_stack
from backend.core.framework import node_def_pb2
from backend.core.framework import versions_pb2
from backend.python import pywrap_tensorflow_internal as pywrap_tensorflow
...
from backend.python import pywrap_tensorflow_internal as c_api
from backend.python.pywrap_tensorflow_internal import TFE_Py_UID as uid
