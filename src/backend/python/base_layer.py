...
from backend.python.ops.init_ops import GlorotUniform as glorot_uniform
from backend.python import function as eager_function
#from backend.python import generic_utils
...
#from backend.python.generic_utils import to_snake_case
