...
from backend.python.ops.init_ops import RandomNormal as TFRandomNormal
from backend.python.ops.init_ops import RandomUniform as TFRandomUniform
from backend.python.ops.init_ops import TruncatedNormal as TFTruncatedNormal
from backend.python.ops.init_ops import GlorotUniform
from backend.python.ops.init_ops import GlorotNormal
from backend.python.ops.init_ops import Orthogonal
from backend.python.ops.init_ops import Identity
from backend.python.ops.init_ops import Constant
from backend.python.ops.init_ops import Zeros
from backend.python.ops.init_ops import Ones
